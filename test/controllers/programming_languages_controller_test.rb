...
class ProgrammingLanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programming_language" do
    assert_difference("ProgrammingLanguage.count") do
      post programming_languages_url, params: { programming_language: { language_name: @programming_language.language_name, resume_id: @programming_language.resume_id, user_id: @programming_language.user_id } }, as: :json
    end
  ...
  test "should update programming_language" do
    patch programming_language_url(@programming_language), params: { programming_language: { language_name: @programming_language.language_name, resume_id: @programming_language.resume_id, user_id: @programming_language.user_id } }, as: :json
    assert_response :success
  end
